...
workflow_router.get('/create/summary/:blueprint_name', summarizeBlueprint_controller)
workflow_router.get('/create/diagram/:blueprint_name', generateBlueprintDiagram_controller)
